...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "BetsResponse.acceptedBets":
		if e.complexity.BetsResponse.AcceptedBets == nil {
			break
		}
	...
	case "BetsResponse.publicPendingBets":
		...
		return e.complexity.BetsResponse.PublicPendingBets(childComplexity), true
	...
	case "Query.getBetMaps":
		if e.complexity.Query.GetBetMaps == nil {
			break
		}

		args, err := ec.field_Query_getBetMaps_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
	...
	case "Query.searchBets":
		...
		args, err := ec.field_Query_searchBets_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.SearchBets(childComplexity, args["search"].(string), args["userId"].(*string), args["betStatus"].(*string)), true
...
func (ec *executionContext) field_Query_getBetMaps_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 *string
...
func (ec *executionContext) field_Query_searchBets_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["search"]; ok {
	...
	args["userId"] = arg1
	var arg2 *string
	if tmp, ok := rawArgs["betStatus"]; ok {
		arg2, err = ec.unmarshalOString2ᚖstring(ctx, tmp)
		if err != nil {
			return nil, err
		}
...
func (ec *executionContext) _BetsResponse_acceptedBets(ctx context.Context, field graphql.CollectedField, obj *types.BetsResponse) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _BetsResponse_finalBets(ctx context.Context, field graphql.CollectedField, obj *types.BetsResponse) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _BetsResponse_publicPendingBets(ctx context.Context, field graphql.CollectedField, obj *types.BetsResponse) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Query_searchBets(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Query_searchBets_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().SearchBets(rctx, args["search"].(string), args["userId"].(*string), args["betStatus"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_getBetMaps(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Query_getBetMaps_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetBetMaps(rctx, args["leagueId"].(*string), args["betType"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputNewBet(ctx context.Context, obj interface{}) (types.NewBet, error) {
	...
	for k, v := range asMap {
		...
		case "leagueId":
			var err error
			it.LeagueId, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		case "betRecipient":
...
var betsResponseImplementors = []string{"BetsResponse"}

func (ec *executionContext) _BetsResponse(ctx context.Context, sel ast.SelectionSet, obj *types.BetsResponse) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, betsResponseImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("BetsResponse")
		case "acceptedBets":
			out.Values[i] = ec._BetsResponse_acceptedBets(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "finalBets":
			out.Values[i] = ec._BetsResponse_finalBets(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "publicPendingBets":
			out.Values[i] = ec._BetsResponse_publicPendingBets(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "pendingBets":
	...
	for i, field := range fields {
		...
		case "searchBets":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Query_searchBets(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
...
func (ec *executionContext) marshalNBet2ᚕᚖbetᚑhoundᚋcmdᚋtypesᚐBet(ctx context.Context, sel ast.SelectionSet, v []*types.Bet) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOBet2ᚖbetᚑhoundᚋcmdᚋtypesᚐBet(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNBetsResponse2betᚑhoundᚋcmdᚋtypesᚐBetsResponse(ctx context.Context, sel ast.SelectionSet, v types.BetsResponse) graphql.Marshaler {
	return ec._BetsResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNBetsResponse2ᚖbetᚑhoundᚋcmdᚋtypesᚐBetsResponse(ctx context.Context, sel ast.SelectionSet, v *types.BetsResponse) graphql.Marshaler {
	if v == nil {
